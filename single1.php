                                ...
                                while( $row = mysqli_fetch_assoc($read_cmnt)){
                                    ...
                                    <div class="row each-comments">
                                        ...
                                        <div class="col-md-10 no-padding">
                                            ...
                                            <?php
                                                if(!empty($_SESSION['email'])){ ?>
                                                    <a href="single.php?post=<?php echo $post_id; ?>&reply=<?php echo $cmnt_id; ?>"><i class="fa fa-comments"></i> Reply</a>
                                                <?php }
                                                else { ?>
                                            ...
                                            <?php
                                                if( isset($_GET['reply']) && !empty($_SESSION['email']) ){
                                                    $reply_id = $_GET['reply'];
                                                    ?>
                                                    <form action="" method="POST" class="contact-form">
                                                        <!-- Right Side Start -->
                                            ...
                                            <?php
                                                if (isset($_POST['replyPostComment'])) {
                                                    ...
                                                    $sql = "INSERT INTO comments (reply_id,cmnt_name,comments,post_id,cmnt_status,cmnt_date) VALUES ('$r_id','$name','$comments','$post_id',1,now())";
                                                    
                                                    $add_reply = mysqli_query($db,$sql);
